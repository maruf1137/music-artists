        ...
        <div className="max-w-7xl m-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <button
              ...
              <svg class="icon h-5 w-5 fill-white">
                  ...
                  <AccordionDetails>
                    <Typography className="text-[#A1A1A2]">
                      <div class=" items-center me-4">
                        ...
                        <div class="checkboxes__item mt-2">
                          <label class="checkbox style-h">
                            <input type="checkbox" />
                            <div class="checkbox__checkmark"></div>
                            <div class="checkbox__body ">Male</div>
                          </label>
                        </div>
                        ...
                        <div class="checkboxes__item mt-2">
                          <label class="checkbox style-h">
                            <input type="checkbox" />
                            <div class="checkbox__checkmark"></div>
                            <div class="checkbox__body">Female</div>
                          </label>
                        </div>
                      </div>
                    </Typography>
                      ...
                      <div class=" items-center me-4">
                        ...
                        <div class="checkboxes__item mt-2">
                          <label class="checkbox style-h">
                            <input type="checkbox" />
                            <div class="checkbox__checkmark"></div>
                            <div class="checkbox__body ">Guitard</div>
                          </label>
                        </div>
                        ...
                        <div class="checkboxes__item mt-2">
                          <label class="checkbox style-h">
                            <input type="checkbox" checked />
                            <div class="checkbox__checkmark"></div>
                            <div class="checkbox__body">Drums</div>
                          </label>
                        </div>
                      </div>
                    </Typography>
              ...
              <div className="">
                <div className="flex justify-between">
                  ...
                  <div>
                    <select
                      id="SortBY"
                      class="bg-[#1D1D1F] w-[99px] lg:w-[130px] p-2 text-[#A1A1A2] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <nav aria-label="Page navigation ">
                  <ul class="items-center -space-x-px h-10 text-base flex justify-center gap-2 ">
                    <li className="">
                      <a
                        href="#"
                        class="rounded flex items-center justify-center px-4 h-10 ms-0 leading-tight text-gray-500 bg-[#353945]  border-gray-300 rounded-s-lg hover:bg-[#E1574B] hover:text-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-[#E1574B] dark:hover:text-[#E1574B]">
                    ...
                    <li>
                      <a
                        href="#"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-gray-100 bg-[#353945] hover:bg-[#E1574B] hover:text-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white rounded-lg">
                        1
                      </a>
                    </li>
                    <li>
                      <a
                        href="#"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-gray-100 bg-[#E1574B] hover:bg-[#] hover:text-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white rounded-lg ">
                        2
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a
                        href="#"
                        class="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-[#353945] rounded hover:bg-[#E1574B] hover:text-gray-100 dark:hover:bg-[E1574B] dark:hover:text-white">
