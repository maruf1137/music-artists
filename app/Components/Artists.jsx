              ...
              <Swiper
                ...
                <SwiperSlide>
                  <div className="SliderBox">
                    <div class="bg-transparent rounded-2xl shadow dark:bg-transparent dark:border-transparent">
                      <a href="#">
                        <Image
                          src="/woman.png"
                          alt="Logo"
                      ...
                      <div class="p-5">
                        ...
                        <div className="lg:flex justify-between">
                          ...
                          <a
                            ...
                            <svg
                              class="rtl:rotate-180 w-3.5 h-3.5 ms-2 lg:text-gray-400"
                              aria-hidden="true"
                ...
                <SwiperSlide>
                  <div className="SliderBox">
                    <div class="max-w-sm bg-transparent rounded-2xl shadow dark:bg-transparent dark:border-transparent">
                      <a href="#">
                        <Image
                          src="/men1.png"
                          alt="Logo"
