    ...
    <div className=" bg-[#141416] ">
      <div class="px-2 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="relative flex items-center justify-between">
          ...
          <ul class="flex items-center hidden space-x-5 lg:flex">
            {navbarData.map(({ id, title, url }) => {
              return (
                <li key={id}>
                  <Link
                    href={url}
                    class={`font-medium tracking-wide text-gray-400 transition-colors duration-200 hover:text-deep-purple-accent-400  ${
                      pathname === url ? "active" : ""
                    }`}>
                    {title}
                  </Link>
            ...
            <li>
              <Link href="">
                <button
                  type="button"
                  class="text-gray-100 hover:text-white border border-gray-300  focus:outline-none focus:ring-gray-300  text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 rounded-full text-[14px] font-bold hover:bg-[#E1574B]">
                  SIGN IN
                </button>
              </Link>
            </li>
          ...
          <div class="lg:hidden z-[99990000000000]">
            <button
            ...
            {isMenuOpen && (
              <div class="absolute top-0 left-0 w-full  ">
                <div class="p-5 bg-[#010101]  rounded shadow-sm">
                  <div class="flex items-center justify-between mb-4">
                    ...
                    <div>
                      <button
                        ...
                        title="Close Menu"
                        class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-800 focus:bg-gray-800 focus:outline-none focus:shadow-outline"
                    ...
                    <ul class="space-y-4 text-center">
                      ...
                      <li className="">
                        <Link href="">
                          <button
                            type="button"
                            class="text-white focus:outline-none border border-gray-400 focus:ring-gray-300 font-bold text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 rounded-full bg-[#E1574B] text-[14px] hover:bg-transparent mt-5 w-full">
                            Create Your Song
                          </button>
                        </Link>
                      </li>
