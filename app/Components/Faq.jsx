...
export const Faq = () => {
  ...
  return (
    <div className="FaqBg">
      <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 mt-[100px]">
        <h2 class="max-w-lg mb-6 text-[32px] lg:text-[40px] font-bold leading-none tracking-tight text-[#fff] sm:text-4xl md:mx-auto">
          Curious? Want to Learn More?
        </h2>
        <p class="text-base text-[#A1A1A2] md:text-lg ">
      ...
      <div className="max-w-7xl mx-auto flex gap-x-20 gap-y-6 px-4 lg:px-6 flex-col lg:flex-row">
            ...
            return (
              <button
                ...
                <div className="icon-box h-5 w-5 bg-current flex items-center justify-between rounded-full">
                  <svg class="icon h-5 w-5 fill-black scale-75">
        ...
        <div className="w-full">
          <div class="space-y-4 text-[#A1A1A2]">
