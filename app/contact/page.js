        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-16 lg:py-[120px]">
          <div className="grid grid-cols-12 items-start gap-y-8">
            ...
            <div className="ContactForm col-span-12 lg:col-span-6">
              <div class="p-5 sm:p-[32px] lg:p-[48px]">
                <form class="w-full">
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      <label
                        class="block capitalize tracking-wide font-normal mb-2 text-[16px] text-[#A1A1A2]"
                        for="grid-first-name">
                        First Name
                      </label>
                      <input
                        class="appearance-none block w-full bg-[#282829] text-gray-300 rounded-lg  py-3 px-4 mb-3 leading-tight focus:outline-none"
                        id="grid-first-name"
                        type="text"
                      />
                    </div>
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      <label class="block capitalize tracking-wide font-normal mb-2 text-[16px] text-[#A1A1A2]">
                        I need info about
                      </label>
                      <select
                        name=""
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <textarea
                        rows="10"
                        class="appearance-none block w-full bg-[#282829] text-gray-300  rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none"></textarea>
                    </div>
