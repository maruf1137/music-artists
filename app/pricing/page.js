    ...
    <div className="pricing-page">
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div class="flex flex-wrap justify-center items-center">
          <div class="price-dialog-box CircleBox text-center h-[420px] w-[420px] flex items-center justify-center flex-col rounded-full p-5 sm:px-20 -mb-5 lg:-mr-5">
            <div className="">
              <Image
                src="/Music.png"
                alt="Logo"
          ...
          <div class="price-dialog-box CircleBox2 h-[420px] w-[420px] flex items-center justify-center flex-col rounded-full p-5 sm:px-20">
            <div className="">
              <Image
                src="/equalizer.png"
                alt="Logo"
          ...
          <div class="price-dialog-box CircleBox3 h-[420px] w-[420px] flex items-center justify-center flex-col rounded-full p-5 sm:px-20 -mt-5 lg:-ml-5">
            <div className="">
              <Image
                src="/Megaphone.png"
                alt="Logo"
      ...
      <div className="CostBox max-w-[957px] mx-auto px-5">
        ...
        <div class="CreateSongBox divide-y lg:divide-y-0 lg:divide-x divide-gray-500 flex flex-col lg:flex-row py-8 sm:py-12 px-6 sm:px-14 lg:px-0">
          <div className="m-auto text-center">
            ...
            <div className="max-w-[300px] mx-auto">
              <button
                type="button"
                class="text-gray-100  focus:outline-none border border-gray-400 focus:ring-gray-300 font-bold text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 rounded-full bg-[#E1574B] text-[14px] hover:bg-transparent mt-5 w-full">
                Start Now
              </button>
            </div>
          </div>
        ...
        <div className="w-full justify-between items-start mt-5 gap-3 hidden lg:flex">
          <div class="Collaboration w-full">
            <h3>Collaboration</h3>
