    ...
    <div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 lg:px-6 py-14 lg:py-20">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div class="ImpactArtistBox col-span-12 lg:col-span-5 p-4 sm:p-16 pt-[184px]">
          ...
          <div class="TopTalantedBox col-span-12 lg:col-span-7 p-4 sm:p-16 pt-[184px]">
            <h3 className="text-[#fff] text-[32px] font-bold leading-7">
              Support Top Talent.
            </h3>
            <p className="text-[#A1A1A2] text-[20px] font-light mt-5">
        ...
        <div class="MusicBox !mt-6 lg:!py-[100px] !py-[60px]">
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <button
                type="button"
                class="text-gray-100 max-w-[190px] focus:outline-none border border-gray-400 focus:ring-gray-300 font-bold text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 rounded-full bg-[#E1574B] text-[14px] hover:bg-transparent mt-5 w-full">
                Create Your Song
              </button>
            </div>
          </div>
